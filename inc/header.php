...
<!-- Header and Nav -->
  <nav class="top-bar" data-topbar>
    <ul class="title-area">
      <li class="name" style="max-width: 60%; padding-bottom: 15px; padding-top: 10px;">
      <a href="fantag.php"><img src="img/Fantag_Header_Logo_White.png"/></a>
      </li>
    ...
    <section class="top-bar-section">
      ...
      <ul class="left" style="padding-left:30px; margin-top:15px;">
        <li class="has-dropdown" style="margin-top:5px;">
          <a href="#" style="border-bottom-width: 0px;">SHOP BY TEAM</a>SHOP BY TEAM</a>
          ...
          <li class="has-form" style="padding-top:13px;">
            <div class="row collapse">
              ...
              <div class="large-3 small-3 columns">
                <a href="#" class="alert button expand" style="
                margin-top: 2px;
                height: 23px;
                "
                >GO!</a>
